...
class ListCheckIn extends StatefulWidget {
  ...
  @override
  _ListCheckInState createState() => _ListCheckInState();
}
...
class _ListCheckInState extends State<ListCheckIn> {
  ...
  void getCurrentLocation() async {
    ...
    setState(() {
      ...
      final myLocation = LatLng(currentLocation.latitude, currentLocation.longitude);
    ...
    print("My Place : ${first.featureName} : ${first.addressLine}");
    setState(() {
      addressLoc = ('${first.addressLine}');
    });
                        ...
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () async {
                              ...
                              var place = addressLoc;
                              print("check In : $addressLoc");
