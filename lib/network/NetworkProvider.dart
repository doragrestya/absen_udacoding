...
abstract class BaseEndPoint {
  Future<List> loginUser(
      String myUsername, String myPassword, BuildContext context);
  Future<List> getAbsent(String myId);
  Future<List> getDetail(String myId);
  Future checkIn(String idUser, String check_in_by, String place);
  void checkOut(
      String idAbsent, String check_out_by, String idUser, String jam_kerja);
  Future<List> getRole();
...
class NetworkProvider extends BaseEndPoint {
  ...
  Future<List> getAbsent(String myId) async {
    ...
    final response = await http
        .post(ConstantFile().baseUrl + "getAbsent", body: {'iduser': myId});
  ...
  @override
  Future checkIn(String idUser, String check_in_by, String place) async {
  ...
  Future<List> getDetail(String myId) async {
    ...
    final response = await http
        .post(ConstantFile().baseUrl + "getDetail", body: {'iduser': myId});
